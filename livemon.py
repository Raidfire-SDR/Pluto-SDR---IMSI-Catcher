...
class grgsm_livemon(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, args="", collector="localhost", collectorport='4729', fc=925800000, gain=55, osr=4, ppm=0, samp_rate=2500000, serverport='4730', shiftoff=400000):
        ...
        self._ppm_slider_win = GrRangeWidget(self._ppm_slider_range, self.set_ppm_slider, "PPM Offset", "counter", float, QtCore.Qt.Horizontal, "value")

        self.top_layout.addWidget(self._ppm_slider_win)
        self._fc_slider_range = Range(800000000, 1990000000, 200000, fc, 100)
        self._fc_slider_win = GrRangeWidget(self._fc_slider_range, self.set_fc_slider, "Frequency", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.rtlsdr_source_0.set_gain(55, 0)
        ...
        self.network_socket_pdu_0 = network.socket_pdu('UDP_SERVER', '127.0.0.1', '4096', 1500, False)
        ...
        self._gain_slider_win = GrRangeWidget(self._gain_slider_range, self.set_gain_slider, "Gain", "counter", float, QtCore.Qt.Horizontal, "value")
    ...
    def set_shiftoff(self, shiftoff):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(0, (250000+abs(self.shiftoff)*64))
...
def argument_parser():
    ...
    parser.add_argument(
        "-f", "--fc", dest="fc", type=eng_float, default=eng_notation.num_to_str(float(925800000)),
        help="Set GSM channel's central frequency [default=%(default)r]")
    parser.add_argument(
        "-g", "--gain", dest="gain", type=eng_float, default=eng_notation.num_to_str(float(55)),
    ...
    parser.add_argument(
        "-s", "--samp-rate", dest="samp_rate", type=eng_float, default=eng_notation.num_to_str(float(2500000)),
        help="Set samp_rate [default=%(default)r]")
    parser.add_argument(
        "--serverport", dest="serverport", type=str, default='4730',
        help="Set UDP server listening port [default=%(default)r]")
    parser.add_argument(
        "-o", "--shiftoff", dest="shiftoff", type=eng_float, default=eng_notation.num_to_str(float(400000)),
